...
export function Terms() {
  return (
    <body className="termsAndPrivacyBody">
      ...
      <p>
        Codelet LLC is committed to ensuring that the app is as useful and
      ...
      <p>
        The Codelet app stores and processes personal data that you have
        ...
        phone’s security features and it could mean that the Codelet app won’t
      ...
      <p>
        You should be aware that there are certain things that Codelet LLC will
        ...
        Wi-Fi, or provided by your mobile network provider, but Codelet LLC
      ...
      <p>
        Along the same lines, Codelet LLC cannot always take responsibility for
        ...
        avail the Service, Codelet LLC cannot accept responsibility.
      </p>
      <p>
        With respect to Codelet LLC’s responsibility for your use of the app,
        ...
        make it available to you. Codelet LLC accepts no liability for any loss,
      ...
      <p>
        ...
        to keep using the app. Codelet LLC does not promise that it will always
      ...
      <p>
        ...
        do not hesitate to contact us at codelet@codelet.app.
      </p>
      <p>
